...
// using CrowbanePackPlugin.Commands.Converters;
// using CrowbanePackPlugin.Models;
using ProjectM;
...
namespace CrowbaneArena.Commands
{
	...
	{
		// [Command("cbrevive", adminOnly: true)]
		...
		[Command("cbrevivetarget", adminOnly: true)]
	...
	internal class ReviveCommandsImpl : ReviveCommands
	{
	}
}
